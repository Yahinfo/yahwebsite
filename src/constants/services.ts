...
export const SERVICES: Service[] = [
  {
    ...
    description:
      "Professional websites that establish your brand presence and drive business growth.",
    icon: "FaBuilding",
    color: "#00E5FF",
    features: [
      "Responsive Design",
  ...
  // },
  {
    ...
    description:
      "Comprehensive QA services ensuring your software meets the highest quality standards.",
    icon: "FaBug",
    color: "#FF6B6B",
    features: [
      "Manual Testing",
  ...
  //   title: "SEO Services",
  //   description:
  //     "Boost your online visibility with data-driven SEO strategies and optimization.",
  //   icon: "FaSearch",
  //   color: "#00FF99",
  //   features: [
  //     "Keyword Research",
