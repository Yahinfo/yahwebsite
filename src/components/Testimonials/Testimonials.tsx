      ...
      <Container maxWidth="lg">
        ...
        >
          <Typography variant="h3" sx={{ textAlign: 'center', mb: 2 }}>
            What Our <Box component="span" className="gradient-text">Students Say</Box>
          </Typography>
        ...
        >
          {items.map((item) => (
            <SwiperSlide key={item.id}>
              ...
              >
                <CardContent sx={{ p: 3 }}>
                  <Rating value={item.rating} readOnly size="small" sx={{ color: '#FFD700', mb: 2 }} />
                  <Typography variant="body2" sx={{ color: 'text.secondary', mb: 3, lineHeight: 1.8, fontStyle: 'italic' }}>
