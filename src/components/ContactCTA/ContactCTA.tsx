    ...
    >
      <Box
        sx={{
          ...
          background: 'linear-gradient(135deg, rgba(0,229,255,0.05), rgba(139,92,246,0.05), rgba(255,215,0,0.03))',
        }}
      />
      <Box
      ...
      <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
        ...
        >
          <Typography variant="h2" sx={{ mb: 2 }}>
            Ready to Start Your{' '}
            <Box component="span" className="gradient-text">Tech Journey?</Box>
          </Typography>
          <Typography variant="body1" sx={{ color: 'text.secondary', mb: 4, maxWidth: 500, mx: 'auto' }}>
            Join 5000+ successful graduates. Enroll today and transform your career with industry-leading training.
          </Typography>
