      ...
      <Container maxWidth="lg">
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              ...
              <Typography variant="h2" sx={{ mt: 1, mb: 3 }}>
                ...
                <Box component="span" className="gradient-text">Tech Education</Box>
              </Typography>
              <Typography variant="body1" sx={{ color: 'text.secondary', mb: 3, maxWidth: 500 }}>
                YahTecInfo is a premier software training institute and IT services company dedicated to
                empowering individuals and businesses with cutting-edge technology skills. With 5000+ successful
                graduates and 50+ industry partners, we bridge the gap between education and employment.
              </Typography>
              <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 500 }}>
                Our mission is to make quality tech education accessible to everyone, combining expert instruction,
                hands-on projects, and dedicated placement support to launch successful careers in technology.
              </Typography>
            </motion.div>
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
        ...
        <Box sx={{ mt: 10 }}>
          <Typography variant="h3" sx={{ textAlign: 'center', mb: 6 }}>
            Why Choose <Box component="span" className="gradient-text">YahTecInfo</Box>
          </Typography>
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        '&:hover': {
                          ...
                          '& .about-icon': { transform: 'scale(1.1)', boxShadow: '0 0 30px rgba(0,229,255,0.3)' },
                        },
                      }}
                    >
                      <Box
                        ...
                        sx={{
                          ...
                          mb: 2, color: 'primary.main', fontSize: '1.3rem',
                          transition: 'all 0.4s ease',
                        }}
                      >
                        <Icon />
