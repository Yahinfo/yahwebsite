                        ...
                        {mod.topics.map((topic) => (
                          <ListItem key={topic} sx={{ py: 0.3, px: 0 }}>
                            <ListItemIcon sx={{ minWidth: 28 }}>
                              <FaCheck color={course.color} size={12} />
                            </ListItemIcon>
                            <ListItemText
                              primary={topic}
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            <Box sx={{ position: { md: "sticky" }, top: 100 }}>
              ...
              >
                {/* <Typography
                  variant="h4"
                  sx={{ color: course.color, fontWeight: 700, mb: 1 }}
                >
                  {course.price}
                </Typography> */}
                <Typography
                ...
                <Button
                  ...
                  sx={{
                    mb: 1.5,
                    background: `linear-gradient(135deg, ${course.color}, #8B5CF6)`,
                    py: 1.5,
                  }}
                >
                  Enroll Now
